...
namespace Server
{
    public class Service1 : IService1
    {
        ...
        public string EgySzendvicsPutCS(Szedvics szedvics)
        {
            if (szedvics != null)
            {
                ...
                else
                {
                    ...
                    return "Adatok modosítása sikeresen megtörtént!";
                }
            }
            else
            {
        ...
        public List<Szedvics> EgySzendvicsGetListCS()
        {
            return SzendvicsekListaja;
        }

        public List<Szedvics> EgySzendvicsGetList()
        {
